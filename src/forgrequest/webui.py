...
.nav{max-width:1500px;margin:0 auto;padding:14px 24px;display:flex;align-items:center;gap:18px;justify-content:space-between}.brand{display:flex;align-items:center;gap:14px;min-width:0}.mark{width:48px;height:48px;border-radius:16px;background:linear-gradient(135deg,var(--accent),#1a7989);display:grid;place-items:center;color:#031018;font-weight:900;box-shadow:0 0 36px rgba(53,214,208,.32);flex:0 0 auto}.title{min-width:0}.title h1{font-size:18px;margin:0}.title p{margin:4px 0 0;color:var(--muted);font-size:13px}.nav-actions{display:flex;align-items:center;justify-content:flex-end;gap:10px;flex:0 0 auto}.shortcut{color:var(--muted);font:12px ui-monospace,SFMono-Regular,Consolas,monospace;border:1px solid #284260;background:#091729;padding:8px 10px;border-radius:10px}.quick-run{display:inline-flex;align-items:center;justify-content:center;gap:9px;min-height:46px;padding:12px 19px;white-space:nowrap;animation:runGlow 2.8s ease-in-out infinite}.run-icon{font-size:14px}.pill{border:1px solid rgba(53,214,208,.35);color:var(--accent2);padding:7px 11px;border-radius:999px;font-size:12px;background:rgba(53,214,208,.08);white-space:nowrap}
.shell{max-width:1500px;margin:0 auto;padding:28px 24px 70px;display:grid;grid-template-columns:300px 1fr;gap:22px}.side{position:sticky;top:88px;align-self:start;background:rgba(17,30,51,.82);border:1px solid var(--line);border-radius:24px;padding:18px;box-shadow:var(--shadow)}.side button{width:100%;text-align:left;border:1px solid transparent;background:transparent;color:var(--muted);border-radius:14px;padding:13px 14px;margin:4px 0;cursor:pointer;font-weight:650}.side button:hover,.side button.active{color:var(--text);border-color:rgba(53,214,208,.28);background:linear-gradient(90deg,rgba(53,214,208,.15),rgba(53,214,208,.03))}.side .side-run-cta{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:0 0 14px;padding:15px 16px;border:1px solid rgba(120,242,212,.62);background:linear-gradient(135deg,var(--accent),#1ea9b2);color:#031018;box-shadow:0 12px 28px rgba(53,214,208,.22);font-weight:900}.side .side-run-cta:hover{color:#031018;border-color:var(--accent2);background:linear-gradient(135deg,var(--accent2),var(--accent));transform:translateY(-1px)}.side-run-cta small{display:block;font-size:10px;font-weight:800;opacity:.68;margin-top:2px}.side .hint{font-size:12px;color:var(--muted);line-height:1.55;padding:14px;border-top:1px solid var(--line);margin-top:12px}
.main{display:grid;gap:18px;min-width:0}.hero{border:1px solid rgba(53,214,208,.22);border-radius:28px;padding:24px;background:linear-gradient(135deg,rgba(17,30,51,.9),rgba(9,17,31,.9));box-shadow:var(--shadow);overflow:hidden;position:relative}.hero:after{content:"";position:absolute;inset:auto -80px -160px auto;width:360px;height:360px;background:radial-gradient(circle,rgba(53,214,208,.18),transparent 65%)}.hero h2{margin:0 0 8px;font-size:30px;letter-spacing:-.04em}.hero p{color:var(--muted);line-height:1.6;max-width:920px}.grid{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));gap:14px}.card{background:rgba(17,30,51,.88);border:1px solid var(--line);border-radius:22px;padding:18px;box-shadow:0 14px 38px rgba(0,0,0,.24);min-width:0}.card h3{margin:0 0 13px;font-size:15px;color:#cceaff}.span12{grid-column:span 12}.span9{grid-column:span 9}.span8{grid-column:span 8}.span6{grid-column:span 6}.span4{grid-column:span 4}.span3{grid-column:span 3}.span2{grid-column:span 2}
label{display:block;color:var(--muted);font-size:12px;font-weight:750;letter-spacing:.06em;text-transform:uppercase;margin:0 0 7px}input:not([type=checkbox]),select,textarea{display:block;width:100%;max-width:100%;min-width:0;background:#071424;border:1px solid #284260;color:var(--text);border-radius:14px;padding:12px 13px;outline:none;font:14px ui-sans-serif,system-ui}input:not([type=checkbox]),select{min-height:46px}textarea{min-height:132px;resize:vertical;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:13px;line-height:1.45}input:focus,select:focus,textarea:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(53,214,208,.12)}.row{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));gap:14px;align-items:start}.row>*{min-width:0}.row>.span2,.row>.span3,.row>.span4{grid-column:span 4}.row>.span6{grid-column:span 6}.row>.span8,.row>.span9{grid-column:span 8}.row>.span12{grid-column:span 12}.checkgrid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px}.check{display:flex;align-items:center;gap:9px;border:1px solid #243b59;border-radius:14px;padding:10px 12px;background:rgba(7,20,36,.64);color:#c9d8ea;font-size:13px;min-width:0}.check input{width:auto;min-width:16px;flex:0 0 auto}.actions{display:flex;gap:12px;flex-wrap:wrap;align-items:center}.btn{border:0;border-radius:15px;padding:12px 16px;cursor:pointer;font-weight:800;letter-spacing:.01em;transition:transform .16s ease,box-shadow .16s ease,opacity .16s ease}.btn:hover:not(:disabled){transform:translateY(-1px)}.primary{background:linear-gradient(135deg,var(--accent),#1ea9b2);color:#031018;box-shadow:0 12px 28px rgba(53,214,208,.25)}.secondary{background:#162940;color:var(--text);border:1px solid #2b4564}.danger{background:rgba(255,107,138,.14);color:#ffc5d0;border:1px solid rgba(255,107,138,.4)}.btn:disabled{opacity:.55;cursor:not-allowed;transform:none}.run-card{display:flex;align-items:center;justify-content:space-between;gap:22px;border-color:rgba(53,214,208,.38);background:linear-gradient(135deg,rgba(18,42,57,.96),rgba(13,23,40,.96));box-shadow:0 18px 45px rgba(0,0,0,.28),0 0 0 1px rgba(53,214,208,.05)}.run-card h3{margin-bottom:6px;font-size:18px}.run-card p{margin:0}.run-card .actions{justify-content:flex-end}.run-card .primary{min-width:180px;min-height:50px;font-size:15px}@keyframes runGlow{0%,100%{box-shadow:0 10px 24px rgba(53,214,208,.20)}50%{box-shadow:0 12px 34px rgba(53,214,208,.38)}}.panel{display:none}.panel.active{display:block}.terminal{background:#040a13;border:1px solid #1d3554;border-radius:22px;padding:0;overflow:hidden}.termbar{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#08182b;border-bottom:1px solid #1d3554}.lights{display:flex;gap:7px}.dot{width:10px;height:10px;border-radius:50%;background:#56697d}.dot:nth-child(1){background:#ff6b8a}.dot:nth-child(2){background:#ffd166}.dot:nth-child(3){background:#7bd88f}.status{font-size:12px;color:var(--muted)}pre{margin:0;padding:16px;white-space:pre-wrap;overflow:auto;max-height:560px;color:#d9f7ff;font:13px/1.5 ui-monospace,SFMono-Regular,Consolas,monospace}.artifacts{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.artifact{display:inline-flex;gap:7px;align-items:center;padding:8px 10px;border:1px solid #2b4564;background:#0d1a2c;border-radius:999px;color:#bdeffd;text-decoration:none;font-size:12px}.mini{font-size:12px;color:var(--muted);line-height:1.5}.kbd{font-family:ui-monospace,SFMono-Regular,Consolas,monospace;color:#a6fff3}.two{display:grid;grid-template-columns:repeat(2,minmax(320px,1fr));gap:14px}.two textarea{min-height:220px}
@media(max-width:1200px){.row>.span2,.row>.span3,.row>.span4,.row>.span6,.row>.span8,.row>.span9{grid-column:span 12}.checkgrid{grid-template-columns:repeat(auto-fit,minmax(240px,1fr))}}
@media(max-width:1050px){.shell{grid-template-columns:1fr}.side{position:relative;top:0}.side .tab{display:inline-block;width:auto}.side .side-run-cta{display:flex;width:100%}.span9,.span8,.span6,.span4,.span3,.span2{grid-column:span 12}.two{grid-template-columns:1fr}.run-card{align-items:flex-start;flex-direction:column}.run-card .actions{width:100%}}
@media(max-width:760px){.shortcut,.pill{display:none}.title p{display:none}.quick-run{padding:11px 14px}.nav{gap:10px}.run-card .actions .btn{flex:1 1 180px}}
@media(max-width:560px){.shell{padding:18px 14px 48px}.nav{padding:11px 14px}.mark{width:42px;height:42px;border-radius:14px}.title h1{font-size:15px}.quick-run{min-height:42px;font-size:13px}.card,.hero,.side{border-radius:18px;padding:16px}.hero h2{font-size:24px}.actions .btn{width:100%}.run-card .primary{min-width:0}.side{padding:14px}}
</style>
</head>
<body>
<header><div class="nav"><div class="brand"><div class="mark">F&gt;_</div><div class="title"><h1>ForgRequest Web Console</h1><p>Local HTTP request replication, modification, reports and diff UI</p></div></div><div class="nav-actions"><span class="shortcut">Ctrl/⌘ + Enter</span><div class="pill" id="version-pill">v</div><button type="button" class="btn primary quick-run run-control" data-run-request><span class="run-icon">▶</span><span class="run-label">Run request</span></button></div></div></header>
<div class="shell">
  <aside class="side">
    <button type="button" class="side-run-cta run-control" data-run-request><span><strong class="run-label">Run request</strong><small>Available from every panel</small></span><span class="run-icon">▶</span></button>
  ...
  <main class="main">
    ...
    <form id="request-form">
      ...
      <section id="execution" class="panel"><div class="grid">
        ...
        <div class="card span12 run-card"><div><h3>Ready to send?</h3><p class="mini">Run the configured request now, or preview the prepared request first. You can also press <span class="kbd">Ctrl+Enter</span> or <span class="kbd">Cmd+Enter</span> from any field.</p></div><div class="actions"><button type="submit" class="btn primary run-control" id="run-btn"><span class="run-icon">▶</span> <span class="run-label">Run request</span></button><button type="button" class="btn secondary" id="dry-btn">Preview dry-run</button><button type="reset" class="btn danger">Reset form</button></div></div>
      </div></section>
    </form>
    ...
    <section class="terminal" id="output-console"><div class="termbar"><div class="lights"><span class="dot"></span><span class="dot"></span><span class="dot"></span></div><div class="status" id="run-status">ready</div></div><pre id="output">Use the panels above, then run a request. Output, generated command and artifacts will appear here.</pre><div class="artifacts" id="artifacts"></div></section>
  </main>
</div>
<script>
...
function collectForm(dryOverride=false){ const data={}; new FormData(requestForm).forEach((v,k)=>{ if(data[k]) data[k]+='\n'+v; else data[k]=v; }); $$('input[type=checkbox]', requestForm).forEach(i=>data[i.name]=i.checked); if(dryOverride) data.dryRun=true; return data; }
function setRunBusy(running){ $$('.run-control').forEach(btn=>{ btn.disabled=running; const label=$('.run-label',btn); if(label) label.textContent=running?'Running…':'Run request'; }); }
function renderResult(r){ $('#run-status').textContent = `exit ${r.exit_code} · ${r.elapsed_seconds||''}s · ${r.job||''}`; let text=`$ ${r.command}\n\n[exit_code] ${r.exit_code}\n\n`; if(r.stdout) text += `[stdout]\n${r.stdout}\n`; if(r.stderr) text += `[stderr]\n${r.stderr}\n`; $('#output').textContent=text; const a=$('#artifacts'); a.innerHTML=''; (r.artifacts||[]).forEach(item=>{ const link=document.createElement('a'); link.className='artifact'; link.href=item.url; link.target='_blank'; link.textContent=`⬇ ${item.name} (${item.size} bytes)`; a.appendChild(link); }); $('#output-console').scrollIntoView({behavior:'smooth',block:'start'}); }
async function postJSON(url, payload){ $('#run-status').textContent='running...'; const res=await fetch(url,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(payload)}); const data=await res.json(); if(!res.ok && data.error){ throw new Error(data.error); } renderResult(data); }
async function runRequest(dryOverride=false){ if(requestForm.dataset.running==='true') return; requestForm.dataset.running='true'; setRunBusy(true); try{ await postJSON('/api/run',collectForm(dryOverride)); }catch(err){ $('#run-status').textContent='request failed'; $('#output').textContent=`[web error] ${err.message||err}`; $('#output-console').scrollIntoView({behavior:'smooth',block:'start'}); }finally{ requestForm.dataset.running='false'; setRunBusy(false); } }
requestForm.addEventListener('submit',e=>{ e.preventDefault(); runRequest(false); });
$$('[data-run-request]').forEach(btn=>btn.addEventListener('click',()=>requestForm.requestSubmit()));
$('#dry-btn').addEventListener('click',()=>runRequest(true));
...
document.addEventListener('keydown',event=>{ if((event.ctrlKey||event.metaKey)&&event.key==='Enter'){ event.preventDefault(); requestForm.requestSubmit(); } });
...
class ForgRequestHandler(BaseHTTPRequestHandler):
    server_version = "ForgRequestWeb/1.7.2"
