...
@media(max-width:1050px){.shell{grid-template-columns:1fr}.side{position:relative;top:0}.side .tab{display:inline-block;width:auto}.span9,.span8,.span6,.span4,.span3,.span2{grid-column:span 12}.two{grid-template-columns:1fr}.run-card{align-items:flex-start;flex-direction:column}.run-card .actions{width:100%}}
  ...
  <main class="main">
    ...
    <form id="request-form">
      ...
      <section id="execution" class="panel"><div class="grid">
        ...
        <div class="card span12 run-card"><div><h3>Execution controls</h3><p class="mini">Use the persistent <strong>Run request</strong> button in the upper-right corner next to the version. You can also press <span class="kbd">Ctrl+Enter</span> or <span class="kbd">Cmd+Enter</span> from any field.</p></div><div class="actions"><button type="button" class="btn secondary" id="dry-btn">Preview dry-run</button><button type="reset" class="btn danger">Reset form</button></div></div>
      </div></section>
    </form>
