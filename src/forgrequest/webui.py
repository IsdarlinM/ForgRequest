...
@media(max-width:1050px){.shell{grid-template-columns:1fr}.side{position:relative;top:0}.side button{display:inline-block;width:auto}.span9,.span8,.span6,.span4,.span3,.span2{grid-column:span 12}.two{grid-template-columns:1fr}}
@media(max-width:560px){.shell{padding:18px 14px 48px}.nav{padding:14px}.card,.hero,.side{border-radius:18px;padding:16px}.hero h2{font-size:24px}.actions .btn{width:100%}}
</style>
</head>
<body>
